...
import { SabbathSchoolViewState, getSubview } from '../types/view-state.js';
...
export function SabbathSchoolView(props: SabbathSchoolViewProps) {
  const [viewState, setViewState] = createSignal<SabbathSchoolViewState>(SabbathSchoolViewState.menu());
