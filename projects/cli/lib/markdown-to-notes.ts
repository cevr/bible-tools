 ...
 */
export const updateAppleNoteFromMarkdown = Effect.fn('updateAppleNoteFromMarkdown')(
  function* (noteId: string, markdownContent: string, options: UpdateNoteOptions = {}) {
    ...
    if (res.startsWith('Error:')) {
      return yield* Effect.fail(new MarkdownParseError({
