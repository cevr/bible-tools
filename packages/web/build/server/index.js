...
function Welcome() {
  return /* @__PURE__ */ jsx("main", { className: "flex items-center justify-center pt-16 pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex min-h-0 flex-1 flex-col items-center gap-16", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full max-w-[300px] space-y-6 px-4", children: /* @__PURE__ */ jsxs("nav", { className: "space-y-4 rounded-3xl border border-gray-200 p-6 dark:border-gray-700", children: [
      /* @__PURE__ */ jsx("p", { className: "text-center leading-6 text-gray-700 dark:text-gray-200", children: "What's next?" }),
